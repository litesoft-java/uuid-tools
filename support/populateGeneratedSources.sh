...
if [ ! -f "support/uuid-codec-support-sources-1.0.2.jar" ]; then
      echo "ERROR: 'support/uuid-codec-support-sources-1.0.2.jar' does not exist"
      exit 1
fi
...
jar -xf ../../../support/uuid-codec-support-sources-1.0.2.jar
retval=$?
